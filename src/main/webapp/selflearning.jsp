    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav2 me-auto mb-2 mb-lg-0">
          <center style="margin-left: 280px;font-size: 30px; font-weight: 600; color: #fff; background: blue; border-radius: 5px;">self learing</center>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="dropdown-item" href="login.jsp">Computer Programming</a></li>
...
<div class="container">
  	<h2>The Easy Guide to Self-Learning for Remote Learning Students</h2>
